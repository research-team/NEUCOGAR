...
nest.Connect(nucleusaccumbens[nucleusaccumbens_5HT][k_IDs], vt_sero_in)
...
connect(lateralcortex[lateralcortex_5HT], DR[DR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(Basalganglia[Basalganglia_5HT], Rostralgroup[Rostralgroup_A1], syn_type=5HT_in, weight_coef=1.000000000)
connect(Basalganglia[Basalganglia_5HT], Rostralgroup[Rostralgroup_A2], syn_type=5HT_in, weight_coef=1.000000000)
connect(entorhinalcortex[entorhinalcortex_5HT], DR[DR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(medialcortex[medialcortex_5HT], DR[DR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(ventraltegmentalarea[ventraltegmentalarea_5HT], DR[DR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(ventraltegmentalarea[ventraltegmentalarea_5HT], ventraltegmentalarea[ventraltegmentalarea_DA], syn_type=5HT_in, weight_coef=1.000000000)
...
connect(nucleusaccumbens[nucleusaccumbens_5HT], nucleusaccumbens[nucleusaccumbens_DA], syn_type=5HT_in, weight_coef=1.000000000)
connect(Cerebralcortex[Cerebralcortex_5HT], DR[DR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(Cerebralcortex[Cerebralcortex_5HT], striatum[striatum_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(Cerebralcortex[Cerebralcortex_5HT], striatum[striatum_DA], syn_type=5HT_in, weight_coef=1.000000000)
connect(Cerebralcortex[Cerebralcortex_5HT], substantianigra[substantianigra_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(Cerebralcortex[Cerebralcortex_5HT], substantianigra[substantianigra_DA], syn_type=5HT_in, weight_coef=1.000000000)
connect(Cerebralcortex[Cerebralcortex_5HT], Basalganglia[Basalganglia_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(Thalamus[Thalamus_5HT], medialcortex[medialcortex_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(Thalamus[Thalamus_5HT], neocortex[neocortex_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(Thalamus[Thalamus_5HT], lateralcortex[lateralcortex_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(Thalamus[Thalamus_5HT], entorhinalcortex[entorhinalcortex_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(Thalamus[Thalamus_5HT], prefrontalcortex[prefrontalcortex_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(Thalamus[Thalamus_5HT], prefrontalcortex[prefrontalcortex_DA], syn_type=5HT_in, weight_coef=1.000000000)
connect(Thalamus[Thalamus_5HT], insularcortex[insularcortex_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(Thalamus[Thalamus_5HT], Cerebralcortex[Cerebralcortex_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(insularcortex[insularcortex_5HT], DR[DR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(septum[septum_5HT], DR[DR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(septum[septum_5HT], MnR[MnR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(septum[septum_5HT], Rostralgroup[Rostralgroup_A1], syn_type=5HT_in, weight_coef=1.000000000)
connect(septum[septum_5HT], Rostralgroup[Rostralgroup_A2], syn_type=5HT_in, weight_coef=1.000000000)
connect(hypothalamus[hypothalamus_5HT], DR[DR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(hippocampus[hippocampus_5HT], DR[DR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(neocortex[neocortex_5HT], DR[DR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(DR[DR_5HT], lateralcortex[lateralcortex_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(DR[DR_5HT], entorhinalcortex[entorhinalcortex_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(DR[DR_5HT], prefrontalcortex[prefrontalcortex_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(DR[DR_5HT], prefrontalcortex[prefrontalcortex_DA], syn_type=5HT_in, weight_coef=1.000000000)
connect(DR[DR_5HT], septum[septum_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(DR[DR_5HT], lateraltegmentalarea[lateraltegmentalarea_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(DR[DR_5HT], nucleusaccumbens[nucleusaccumbens_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(DR[DR_5HT], nucleusaccumbens[nucleusaccumbens_DA], syn_type=5HT_in, weight_coef=1.000000000)
connect(DR[DR_5HT], striatum[striatum_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(DR[DR_5HT], striatum[striatum_DA], syn_type=5HT_in, weight_coef=1.000000000)
connect(DR[DR_5HT], bednucleusofthestriaterminalis[bednucleusofthestriaterminalis_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(DR[DR_5HT], Thalamus[Thalamus_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(DR[DR_5HT], Basalganglia[Basalganglia_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(DR[DR_5HT], amygdala[amygdala_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(DR[DR_5HT], hippocampus[hippocampus_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(MnR[MnR_5HT], ventraltegmentalarea[ventraltegmentalarea_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(MnR[MnR_5HT], ventraltegmentalarea[ventraltegmentalarea_DA], syn_type=5HT_in, weight_coef=1.000000000)
connect(MnR[MnR_5HT], hypothalamus[hypothalamus_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(MnR[MnR_5HT], Thalamus[Thalamus_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(MnR[MnR_5HT], neocortex[neocortex_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(MnR[MnR_5HT], medialcortex[medialcortex_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(MnR[MnR_5HT], Cerebralcortex[Cerebralcortex_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(MnR[MnR_5HT], hippocampus[hippocampus_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(MnR[MnR_5HT], insularcortex[insularcortex_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(pons[pons_5HT], MnR[MnR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(Periaqueductalgray[Periaqueductalgray_5HT], MnR[MnR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(prefrontalcortex[prefrontalcortex_5HT], DR[DR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(prefrontalcortex[prefrontalcortex_5HT], DR[DR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(prefrontalcortex[prefrontalcortex_5HT], MnR[MnR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
connect(prefrontalcortex[prefrontalcortex_5HT], Rostralgroup[Rostralgroup_A1], syn_type=5HT_in, weight_coef=1.000000000)
connect(prefrontalcortex[prefrontalcortex_5HT], Rostralgroup[Rostralgroup_A2], syn_type=5HT_in, weight_coef=1.000000000)
connect(prefrontalcortex[prefrontalcortex_5HT], prefrontalcortex[prefrontalcortex_DA], syn_type=5HT_ex, weight_coef=1.000000000)
...
connect(prefrontalcortex[prefrontalcortex_DA], DR[DR_5HT], syn_type=5HT_in, weight_coef=1.000000000)
...
connect(substantianigra[substantianigra_5HT], substantianigra[substantianigra_DA], syn_type=5HT_in, weight_coef=1.000000000)
