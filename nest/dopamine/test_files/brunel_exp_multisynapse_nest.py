...
'''
RESULT
  0 %: network time: 0.0 ms, realtime factor: 0.0000
May 06 11:05:17 Scheduler::update [Info]:
    Simulating using OpenMP.
100 %: network time: 999.0 ms, realtime factor: 0.0035

May 06 11:10:04 Scheduler::resume [Info]:
    Simulation finished.

May 06 11:10:04 Scheduler::finalize_nodes() [Info]:
     using OpenMP.
...
Building time     : 6.52 s
Simulation time   : 286.93 s
'''
...
# PSP-time-constant-array available in each neuron ranging 
# from 0.1 ms to 1.09 ms 
