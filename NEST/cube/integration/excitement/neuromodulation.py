...
add_connection(striatum[striatum_tan], lc[lc_GABA], syn_type=GABA, weight_coef=0.005)
add_connection(vta[vta_DA0], lc[lc_D1], syn_type=DA_ex, weight_coef=0.005)
add_connection(vta[vta_DA0], lc[lc_D2], syn_type=DA_in, weight_coef=0.005)
add_connection(vta[vta_DA1], striatum[striatum_tan], syn_type=DA_ex, weight_coef=0.005)
add_connection(vta[vta_DA1], striatum[striatum_GABA], syn_type=DA_ex, weight_coef=0.005)
...
if noradrenaline_flag:
    ...
    add_connection(vta[vta_a1], vta[vta_DA1], syn_type=NA_in, weight_coef=0.005)
...
if dopamine_flag:
    ...
    # MESOCORTICOLIMBIC
    add_connection(vta[vta_DA0], striatum[striatum_D1], syn_type=DA_ex)
    add_connection(vta[vta_DA0], striatum[striatum_D2], syn_type=DA_in)
