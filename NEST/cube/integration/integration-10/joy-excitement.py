...
connect_generator(motor[motor_Glu0], 100., 250., rate=250, coef_part=1)
connect_generator(pptg[pptg_GABA], 100., 250., rate=250, coef_part=1)
connect_generator(pptg[pptg_Glu], 100., 250., rate=250, coef_part=1)
connect_generator(pptg[pptg_ACh], 100., 250., rate=250, coef_part=1)
connect_generator(amygdala[amygdala_Glu], 100., 250., rate=250, coef_part=1)
connect_generator(snc[snc_DA], 100., 250., rate=250, coef_part=1)
connect_generator(vta[vta_DA0], 100., 250., rate=250, coef_part=1)
