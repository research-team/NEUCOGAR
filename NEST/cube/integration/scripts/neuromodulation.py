...
add_connection(thalamus[thalamus_Glu], motor[motor_5HT], syn_type=Glu, weight_coef=0.005)
...
add_connection(prefrontal[pfc_Glu1], bnst[bnst_Glu], syn_type=Glu, weight_coef=0.005)
...
add_connection(bnst[bnst_GABA], hypothalamus[hypothalamus_pvn_GABA], syn_type=GABA, weight_coef=0.005)
...
add_connection(amygdala[amygdala_Glu], striatum[striatum_D1], syn_type=Glu, weight_coef=0.005)
add_connection(amygdala[amygdala_Glu], striatum[striatum_D2], syn_type=Glu, weight_coef=0.005)
add_connection(amygdala[amygdala_Glu], striatum[striatum_tan], syn_type=Glu, weight_coef=0.005)
add_connection(amygdala[amygdala_Glu], striatum[striatum_5HT], syn_type=Glu, weight_coef=0.005)
add_connection(amygdala[amygdala_Glu], striatum[striatum_Ach], syn_type=Glu, weight_coef=0.005)
add_connection(amygdala[amygdala_Glu], striatum[striatum_GABA], syn_type=Glu, weight_coef=0.005)
add_connection(amygdala[amygdala_Glu], nac[nac_GABA1], syn_type=Glu, weight_coef=0.005)
add_connection(amygdala[amygdala_Glu], nac[nac_GABA0], syn_type=Glu, weight_coef=0.005)
add_connection(amygdala[amygdala_Glu], nac[nac_5HT], syn_type=Glu, weight_coef=0.005)
add_connection(amygdala[amygdala_Glu], nac[nac_NA], syn_type=Glu, weight_coef=0.005)
add_connection(amygdala[amygdala_Glu], nac[nac_ACh], syn_type=Glu, weight_coef=0.005)
add_connection(amygdala[amygdala_Glu], nac[nac_DA], syn_type=Glu, weight_coef=0.005)
add_connection(hypothalamus[hypothalamus_pvn_GABA], motor[motor_Glu0], syn_type=GABA, weight_coef=0.005)
add_connection(hypothalamus[hypothalamus_pvn_GABA], motor[motor_Glu1], syn_type=GABA, weight_coef=0.005)
add_connection(hypothalamus[hypothalamus_pvn_GABA], motor[motor_5HT], syn_type=GABA, weight_coef=0.005)
...
add_connection(vta[vta_D1], striatum[striatum_tan], syn_type=DA_ex, weight_coef=0.005)
add_connection(vta[vta_D1], striatum[striatum_GABA], syn_type=DA_ex, weight_coef=0.005)
...
add_connection(pptg[pptg_ACh], striatum[striatum_D1], syn_type=ACh, weight_coef=0.3)
...
if noradrenaline_flag:
    ...
    add_connection(nts[nts_a2], striatum[striatum_tan], syn_type=NA_ex, weight_coef=0.005)
    add_connection(nts[nts_a2], striatum[striatum_GABA], syn_type=NA_ex, weight_coef=0.005)
    ...
    add_connection(lc[lc_N1], striatum[striatum_tan], syn_type=NA_ex, weight_coef=0.005)
    add_connection(lc[lc_N1], striatum[striatum_GABA], syn_type=NA_ex, weight_coef=0.005)
    ...
    add_connection(rn[rn_a1], rn[rn_dr], syn_type=NA_ex, weight_coef=0.005)
    add_connection(rn[rn_a2], rn[rn_mnr], syn_type=NA_ex, weight_coef=0.005)
    add_connection(rn[rn_a2], rn[rn_rpa], syn_type=NA_ex, weight_coef=0.005)
    add_connection(rn[rn_a2], rn[rn_rmg], syn_type=NA_ex, weight_coef=0.005)
...
if serotonin_flag:
    ...
    connect(pons[pons_5HT], rn[rn_mnr], syn_type=SERO_ex, weight_coef=wse)
    ...
    connect(reticular_formation[reticular_formation_5HT], rn[rn_dr], syn_type=SERO_ex, weight_coef=wse)
    connect(reticular_formation[reticular_formation_5HT], rn[rn_rpa], syn_type=SERO_ex, weight_coef=wse)
    connect(reticular_formation[reticular_formation_5HT], rn[rn_rmg], syn_type=SERO_ex, weight_coef=wse)
...
if dopamine_flag:
    ...
    add_connection(snc[snc_DA], striatum[striatum_D1], syn_type=DA_ex)
    ...
    add_connection(snc[snc_DA], striatum[striatum_D2], syn_type=DA_in)
    add_connection(snc[snc_DA], striatum[striatum_tan], syn_type=DA_in)

    # MESOCORTICOLIMBIC
    add_connection(vta[vta_D0], striatum[striatum_D1], syn_type=DA_ex)
    add_connection(vta[vta_D0], striatum[striatum_D2], syn_type=DA_in)
