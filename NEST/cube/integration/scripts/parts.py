...
vta = ({k_name: 'VTA [Da0]'},
       ...
       {k_name: 'VTA [GABA2]'},
       {k_name: 'VTA [a1]'})
vta_D0, vta_D1, vta_5HT, vta_GABA0, vta_GABA1, vta_GABA2, vta_a1 = range(7)
...
striatum_D1, striatum_D2, tan, striatum_5HT, striatum_Ach, striatum_GABA = range(6)
...
hypothalamus = ({k_name: 'Hypothalamus [5HT]'},
                {k_name: 'Hypothalmus's paraventricular nucleus [GABA]'})
